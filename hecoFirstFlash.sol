...
contract hecoFirstFlashLoan is FlashLoanReceiverBase {
  using SafeERC20 for IERC20;
  ...
  uint256 falshUsdt;
  address usdtins = 0x04F535663110A392A6504839BEeD34E019FdB4E0;
  ...
  function flashDeposit(ILendingPool _lendingPool) public {
    ...
    IERC20(usdtins).approve(address(_lendingPool), falshUsdt);
    // deposit the flashed AAVE, DAI and LINK as collateral
    _lendingPool.deposit(usdtins, falshUsdt, address(this), uint16(0));
        
  }


  function flashWithdraw(ILendingPool _lendingPool) public {
    _lendingPool.withdraw(usdtins, falshUsdt, address(this));
  }
  ...
  */
  function flashBorrow(ILendingPool _lendingPool, address _borrowAsset, uint256 _borrowAmt) public {
    ...
    */
    function flashRepay(ILendingPool _lendingPool, address _repayAsset, uint256 _repayAmt) public {
        ...
        IERC20(usdtins).approve(address(_lendingPool), _repayAmt);
  ...
  function executeOperation(
    ...
    flashDeposit(LENDING_POOL);
    
    flashBorrow(LENDING_POOL, usdtins, falshUsdt);
        
    flashRepay(LENDING_POOL, usdtins, falshUsdt);
 
    flashWithdraw(LENDING_POOL);
  ...
  function myFlashLoanCall() public {
        ...
        assets[0] = address(0x04F535663110A392A6504839BEeD34E019FdB4E0);
